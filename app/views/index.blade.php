...
<div class="indexblock">
	<h1 style="color: #FFF; font-size: 38px; font-weight: bold; text-shadow: 1px 1px 1px #333;">Welcome to Visit Our Service!</h1>
...
<script>
	...
	$(function(){
		window.socket = {};
		socket = io.connect( 'http://185.144.156.100:8081' );
