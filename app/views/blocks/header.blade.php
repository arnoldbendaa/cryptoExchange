...
$btc_usd = $json["last_price"];
echo "$btc_usd";
// LTC

$url = "https://api.bitfinex.com/v1/ticker/ltcusd";
$json = json_decode(file_get_contents($url), true);
$ltc_usd = $json["last_price"];
echo "$ltc_usd"; ?>
    <nav class="navbar navbar-default navbar-fixed-top dash-navbar-top dnl-visible">
      <div class="container-sm">
        ...
        <div id="navbar" class="navbar-collapse collapse">
          ...
          @else
            <li class="dropdown">
              <a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-expanded="false"><img src="http://www.gravatar.com/avatar/<?php echo md5( strtolower( trim( Confide::user()->email ) ) ); ?>" height="33px" border="0" style="border-radius:60px;" /> {{trans('user_texts.hello')}} {{Confide::user()->username}} <span class="caret"></span></a>
              <ul class="dropdown-menu" role="menu">
