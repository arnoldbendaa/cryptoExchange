...
process.on('SIGINT', function () {
  try {
    ...
    var ws = new WebSocket('ws://185.144.156.100:9001/updateReports?agent=ws');
...
function nextTest() {
  ...
  var ws = new WebSocket('ws://185.144.156.100:9001/runCase?case=' + currentTest + '&agent=ws');
...
var ws = new WebSocket('ws://185.144.156.100:9001/getCaseCount');
ws.on('message', function(data, flags) {
